      ...
      <div className="app flex-row align-items-center">
              ...
              <Card className="mx-4">
                <CardBody className="p-4">
                  <Form >
                    ...
                    <InputGroup className="mb-3">
                    <Input  checked="checked" type="radio" name="currency_id" value="1" autoComplete="off" />
                      EUR (Ratelists billing and payment in EUR)
                    </InputGroup>
                    <InputGroup className="mb-3">
                      <Input type="radio" name="currency_id" value="2" autoComplete="off" />
        ...
        <option value="" selected=""></option>
            ...
            <option value="239"> Zimbabwe </option>
                    ...
                    <InputGroup className="mb-3">
                    <Input checked="checked" id="device_type_SIP" name="device_type" type="radio" value="SIP" autocomplete="off" /> SIP
                    </InputGroup>
                    <InputGroup>
                    <Input id="device_type_IAX2" name="device_type" type="radio" value="IAX2" autocomplete="off" /> IAX2
                    </InputGroup>
